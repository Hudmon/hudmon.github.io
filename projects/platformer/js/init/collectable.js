(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.kennedi, 395, 555, 6, 0.8);
        collectable.create(type.max, 100, 100);
        collectable.create(type.grace, 50, 100);
        collectable.create(type.kennedi, 20, 25);
